	...
	for (var i = 0; i < this.particleCount; i++)
	{
		if ( this.particleArray[i].alive )
		{
			...
			// 	// update particle color
				this.particleArray[i].color.r = valueAudio/1.36/1 || 70/255;
				this.particleArray[i].color.g = valueAudio/1.36/1 || 68/255;
				this.particleArray[i].color.b = valueAudio/1.36/1 || 81 /255;
