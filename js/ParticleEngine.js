	...
	for (var i = 0; i < this.particleCount; i++)
	{
		if ( this.particleArray[i].alive )
		{
			...
			// 	// update particle color
				this.particleArray[i].color.r = valueAudio/1.23/50 || 0.1;
				this.particleArray[i].color.g = valueAudio/1.41/50 || 0.2;
				this.particleArray[i].color.b = valueAudio/4.32/50 || 0.2;
